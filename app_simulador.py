...
# --------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if tiene_bateria:
            ...
            df_e1, _ = ejecutar_motor_optimizado(
                ...
                max_ciclos=1, descarga_red=False, precio_min_descarga=0.0, permitir_carga_red=False, precio_max_carga=0.0, coste_ciclo=0.0, deg_ciclo=0.0
            )
            ...
            df_e2, kpis_e2 = ejecutar_motor_optimizado(
                ...
                max_ciclos=max_ciclos, descarga_red=False, precio_min_descarga=0.0, permitir_carga_red=False, precio_max_carga=0.0, coste_ciclo=0.0, deg_ciclo=deg_ciclo
            )
            ...
            if descarga_red:
                df_e3, kpis_e3 = ejecutar_motor_optimizado(
                    ...
                    cap_bateria=cap_bateria, pot_inversor=pot_inversor, soc_maximo=soc_maximo, soc_minimo=soc_minimo, soc_inicial=soc_inicial, 
                    rend_carga=rend_carga, rend_descarga=rend_descarga, potencia_fv_kwp=potencia_fv_kwp, perdidas_fv=perdidas_fv, 
                    max_ciclos=max_ciclos, descarga_red=True, precio_min_descarga=precio_min_descarga, permitir_carga_red=False, precio_max_carga=0.0, coste_ciclo=coste_ciclo, deg_ciclo=deg_ciclo
                )
            ...
            if permitir_carga_red:
                df_e4, kpis_e4 = ejecutar_motor_optimizado(
                    ...
                    cap_bateria=cap_bateria, pot_inversor=pot_inversor, soc_maximo=soc_maximo, soc_minimo=soc_minimo, soc_inicial=soc_inicial, 
                    rend_carga=rend_carga, rend_descarga=rend_descarga, potencia_fv_kwp=potencia_fv_kwp, perdidas_fv=perdidas_fv, 
                    max_ciclos=max_ciclos, descarga_red=False, precio_min_descarga=0.0, permitir_carga_red=True, precio_max_carga=precio_max_carga, coste_ciclo=0.0, deg_ciclo=deg_ciclo
                )
            ...
            if descarga_red and permitir_carga_red:
                df_e5, kpis_e5 = ejecutar_motor_optimizado(
                    ...
                    cap_bateria=cap_bateria, pot_inversor=pot_inversor, soc_maximo=soc_maximo, soc_minimo=soc_minimo, soc_inicial=soc_inicial, 
                    rend_carga=rend_carga, rend_descarga=rend_descarga, potencia_fv_kwp=potencia_fv_kwp, perdidas_fv=perdidas_fv, 
                    max_ciclos=max_ciclos, descarga_red=True, precio_min_descarga=precio_min_descarga, permitir_carga_red=True, precio_max_carga=precio_max_carga, coste_ciclo=coste_ciclo, deg_ciclo=deg_ciclo
                )
        else:
            df_e1 = df_final
        ...
        def agrupar_a_mensual(df_horario):
            ...
            try:
                ...
                if df_temp['Mes_Num'].isnull().any():
                    ...
                    fecha_inicio = fechas_validas.iloc if not fechas_validas.empty else pd.Timestamp(year=pd.Timestamp.now().year, month=1, day=1)
                ...
                fecha_inicio = fechas.iloc if not fechas.empty else pd.Timestamp(year=pd.Timestamp.now().year, month=1, day=1)
