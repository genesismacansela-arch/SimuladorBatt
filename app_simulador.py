...
#--------------------------------------------------------------------------------------------------
        ...
        if permitir_carga_red and 'CARGA BAT. RED (kWh)' in df_final.columns and Consumo_Red > 0:
            ...
            delta_dependencia = f"{formato_es(dependencia, 1)}% | {formato_es(pct_red_bat, 1)}% a batería"
        else:
            delta_dependencia = f"{formato_es(dependencia, 1)}%"   
        col2.metric(
        ...
        with st.expander(" Métricas Globales "):
            ...
            if 'PRECIO RED (€/MWh)' in df_final.columns:
                ...
                c5.metric("Gasto Total Red", f"{formato_es(gasto_total_eur, 2)} €")
            else:
                c5.metric("Gasto Total Red", "Sin datos de precio")
