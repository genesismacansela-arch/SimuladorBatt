...
# --------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        # --- INYECCIÓN DE MÉTRICAS DE HARDWARE DE BATERÍA ---
        if tiene_bateria:
            filas_bateria = [
                {
                    "Métrica": "Ciclos Reales Equivalentes Bateria (ciclos/año)",
                    "E1 - Sin Batería": 0.0,
                    "E2 - Con Batería": round(kpis_e2.get("ciclos_equivalentes", 0.0), 1),
                    "E4 - Carga Red": round(kpis_e4.get("ciclos_equivalentes", 0.0), 1)
                },
                {
                    "Métrica": "Degradación Anual Calculada Bateria (% anual)",
                    "E1 - Sin Batería": 0.0,
                    "E2 - Con Batería": round(kpis_e2.get("degradacion_anual", 0.0), 3),
                    "E4 - Carga Red": round(kpis_e4.get("degradacion_anual", 0.0), 3)
                },
                {
                    "Métrica": "Máxima Carga Batería (kWh)",
                    "E1 - Sin Batería": 0.0,
                    "E2 - Con Batería": df_e2['CARGA BATERIA (kWh)'].max() if 'CARGA BATERIA (kWh)' in df_e2.columns else 0.0,
                    "E4 - Carga Red": df_e4['CARGA BATERIA (kWh)'].max() if 'CARGA BATERIA (kWh)' in df_e4.columns else 0.0
                },
                {
                    "Métrica": "Máxima Descarga Batería (kWh)",
                    "E1 - Sin Batería": 0.0,
                    "E2 - Con Batería": df_e2['DESCARGA DE BATERIA (kWh)'].max() if 'DESCARGA DE BATERIA (kWh)' in df_e2.columns else 0.0,
                    "E4 - Carga Red": df_e4['DESCARGA DE BATERIA (kWh)'].max() if 'DESCARGA DE BATERIA (kWh)' in df_e4.columns else 0.0
                },
                {
                    "Métrica": "Energía Total Aportada por Batería (kWh)",
                    "E1 - Sin Batería": 0.0,
                    "E2 - Con Batería": round(df_e2['DESCARGA DE BATERIA (kWh)'].sum(), 2) if 'DESCARGA DE BATERIA (kWh)' in df_e2.columns else 0.0,
                    "E4 - Carga Red": round(df_e4['DESCARGA DE BATERIA (kWh)'].sum(), 2) if 'DESCARGA DE BATERIA (kWh)' in df_e4.columns else 0.0
                }
            ]
            # Concatenamos las nuevas filas al DataFrame comparativo original
